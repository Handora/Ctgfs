...
class rpcs : public chanmgr {
 ...
 private:
  ...
  void gc_reply_window(unsigned int clt_nonce, unsigned int xid_rep);
 ...
 public:
  ...
  void reg(unsigned int proc, S *, int (S::*meth)(const A1, const A2, const A3,
                                                  const A4, const A5, R &r));
