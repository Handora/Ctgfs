...
class extent_client_cache : public extent_client {
 public:
  ...
  extent_protocol::status setattr(extent_protocol::extentid_t id,
                                  extent_protocol::attr&);
 ...
 private:
  ...
  extent_protocol::status callGet(extent_protocol::extentid_t id,
                                  std::string& buf);
  extent_protocol::status callGetAttr(extent_protocol::extentid_t id,
                                      extent_protocol::attr& attr);
  extent_protocol::status callRemove(extent_protocol::extentid_t id, int& r);
  extent_protocol::status callPut(extent_protocol::extentid_t id, std::string&,
                                  int& r);
  extent_protocol::status callSetAttr(extent_protocol::extentid_t id,
                                      extent_protocol::attr& attr, int& r);
};
